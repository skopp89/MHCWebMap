...
var format_NY_Counties_1 = new ol.format.GeoJSON();
var features_NY_Counties_1 = format_NY_Counties_1.readFeatures(json_NY_Counties_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NY_Counties_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NY_Counties_1.addFeatures(features_NY_Counties_1);
var lyr_NY_Counties_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NY_Counties_1, 
                style: style_NY_Counties_1,
                popuplayertitle: 'NY_Counties',
                interactive: true,
                title: '<img src="styles/legend/NY_Counties_1.png" /> NY_Counties'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_NY_Counties_1.setVisible(true);lyr_MentalHealthCenters_2.setVisible(true);lyr_ServesChildren_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_NY_Counties_1,lyr_MentalHealthCenters_2,lyr_ServesChildren_3];
lyr_NY_Counties_1.set('fieldAliases', {'NAME': 'NAME', 'ABBREV': 'ABBREV', 'GNIS_ID': 'GNIS_ID', 'FIPS_CODE': 'FIPS_CODE', 'SWIS': 'SWIS', 'NYSP_ZONE': 'NYSP_ZONE', 'POP1990': 'POP1990', 'POP2000': 'POP2000', 'POP2010': 'POP2010', 'POP2020': 'POP2020', 'DOS_LL': 'DOS_LL', 'DOSLL_DATE': 'DOSLL_DATE', 'NYC': 'NYC', 'CALC_SQ_MI': 'CALC_SQ_MI', 'DATEMOD': 'DATEMOD', });
...
lyr_NY_Counties_1.set('fieldImages', {'NAME': 'TextEdit', 'ABBREV': 'Hidden', 'GNIS_ID': 'Hidden', 'FIPS_CODE': 'Hidden', 'SWIS': 'Hidden', 'NYSP_ZONE': 'Hidden', 'POP1990': 'Hidden', 'POP2000': 'Hidden', 'POP2010': 'Hidden', 'POP2020': 'Hidden', 'DOS_LL': 'Hidden', 'DOSLL_DATE': 'Hidden', 'NYC': 'Hidden', 'CALC_SQ_MI': 'Hidden', 'DATEMOD': 'Hidden', });
...
lyr_NY_Counties_1.set('fieldLabels', {'NAME': 'no label', });
lyr_MentalHealthCenters_2.set('fieldLabels', {'Name': 'header label - always visible', 'Agency': 'inline label - always visible', 'Website': 'inline label - always visible', 'Population': 'inline label - always visible', 'Hours': 'inline label - always visible', 'Insurances': 'inline label - always visible', 'Phone': 'inline label - always visible', 'Floor': 'inline label - always visible', 'County': 'inline label - always visible', 'Region': 'inline label - always visible', 'Address': 'header label - always visible', 'path': 'inline label - always visible', 'TrainStop': 'inline label - always visible', 'Busroute': 'inline label - always visible', 'Provider': 'inline label - always visible', 'TrainLine': 'inline label - always visible', });
